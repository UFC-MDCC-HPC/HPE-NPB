		...
		for (k = 1; k <= grid_points[2] - 2; k++) {
			...
			for (j = 1; j <= grid_points[1] - 2; j++) {
				...
				for (i = 0; i <= grid_points[0] - 1; i++) {
					...
					buf[i][0] = cuf[i] + buf[i][2] * buf[i][2] + buf[i][3]
							* buf[i][3];
					q[i] = 0.5 * (buf[i][1] * ue[i][1] + buf[i][2] * ue[i][2] + buf[i][3]
							* ue[i][3]);
				...
				for (i = 1; i <= grid_points[0] - 2; i++) {
					...
					forcing[0][i][j][k] = forcing[0][i][j][k] - tx2
							* (ue[ip1][1] - ue[im1][1]) + dx1tx1
							* (ue[ip1][0] - 2.0 * ue[i][0] + ue[im1][0]);

					forcing[1][i][j][k] = forcing[1][i][j][k]
							- tx2
							* ((ue[ip1][1] * buf[ip1][1] + c2
									* (ue[ip1][4] - q[ip1])) - (ue[im1][1]
									* buf[im1][1] + c2 * (ue[im1][4] - q[im1])))
							+ xxcon1
							* (buf[ip1][1] - 2.0 * buf[i][1] + buf[im1][1])
							+ dx2tx1
							* (ue[ip1][1] - 2.0 * ue[i][1] + ue[im1][1]);

					forcing[2][i][j][k] = forcing[2][i][j][k]
							- tx2
							* (ue[ip1][2] * buf[ip1][1] - ue[im1][2]
									* buf[im1][1]) + xxcon2
							* (buf[ip1][2] - 2.0 * buf[i][2] + buf[im1][2])
							+ dx3tx1
							* (ue[ip1][2] - 2.0 * ue[i][2] + ue[im1][2]);

					forcing[3][i][j][k] = forcing[3][i][j][k]
							- tx2
							* (ue[ip1][3] * buf[ip1][1] - ue[im1][3]
									* buf[im1][1]) + xxcon2
							* (buf[ip1][3] - 2.0 * buf[i][3] + buf[im1][3])
							+ dx4tx1
							* (ue[ip1][3] - 2.0 * ue[i][3] + ue[im1][3]);

					forcing[4][i][j][k] = forcing[4][i][j][k]
							- tx2
							* (buf[ip1][1] * (c1 * ue[ip1][4] - c2 * q[ip1]) - buf[im1][1]
									* (c1 * ue[im1][4] - c2 * q[im1])) + 0.5
							* xxcon3
							* (buf[ip1][0] - 2.0 * buf[i][0] + buf[im1][0])
							+ xxcon4 * (cuf[ip1] - 2.0 * cuf[i] + cuf[im1])
							+ xxcon5
							* (buf[ip1][4] - 2.0 * buf[i][4] + buf[im1][4])
							+ dx5tx1
							* (ue[ip1][4] - 2.0 * ue[i][4] + ue[im1][4]);
		...
		for (k = 1; k <= grid_points[2] - 2; k++) {
			...
			for (i = 1; i <= grid_points[0] - 2; i++) {
				...
				for (j = 0; j <= grid_points[1] - 1; j++) {
					...
					buf[j][0] = cuf[j] + buf[j][1] * buf[j][1] + buf[j][3]
							* buf[j][3];
					q[j] = 0.5 * (buf[j][1] * ue[j][1] + buf[j][2] * ue[j][2] + buf[j][3]
							* ue[j][3]);
				}
				...
				for (j = 1; j <= grid_points[1] - 2; j++) {
					...
					forcing[0][i][j][k] = forcing[0][i][j][k] - ty2
							* (ue[jp1][2] - ue[jm1][2]) + dy1ty1
							* (ue[jp1][0] - 2.0 * ue[j][0] + ue[jm1][0]);

					forcing[1][i][j][k] = forcing[1][i][j][k]
							- ty2
							* (ue[jp1][1] * buf[jp1][2] - ue[jm1][1]
									* buf[jm1][2]) + yycon2
							* (buf[jp1][1] - 2.0 * buf[j][1] + buf[jm1][1])
							+ dy2ty1
							* (ue[jp1][1] - 2.0 * ue[j][1] + ue[jm1][1]);

					forcing[2][i][j][k] = forcing[2][i][j][k]
							- ty2
							* ((ue[jp1][2] * buf[jp1][2] + c2
									* (ue[jp1][4] - q[jp1])) - (ue[jm1][2]
									* buf[jm1][2] + c2 * (ue[jm1][4] - q[jm1])))
							+ yycon1
							* (buf[jp1][2] - 2.0 * buf[j][2] + buf[jm1][2])
							+ dy3ty1
							* (ue[jp1][2] - 2.0 * ue[j][2] + ue[jm1][2]);

					forcing[3][i][j][k] = forcing[3][i][j][k]
							- ty2
							* (ue[jp1][3] * buf[jp1][2] - ue[jm1][3]
									* buf[jm1][2]) + yycon2
							* (buf[jp1][3] - 2.0 * buf[j][3] + buf[jm1][3])
							+ dy4ty1
							* (ue[jp1][3] - 2.0 * ue[j][3] + ue[jm1][3]);

					forcing[4][i][j][k] = forcing[4][i][j][k]
							- ty2
							* (buf[jp1][2] * (c1 * ue[jp1][4] - c2 * q[jp1]) - buf[jm1][2]
									* (c1 * ue[jm1][4] - c2 * q[jm1])) + 0.5
							* yycon3
							* (buf[jp1][0] - 2.0 * buf[j][0] + buf[jm1][0])
							+ yycon4 * (cuf[jp1] - 2.0 * cuf[j] + cuf[jm1])
							+ yycon5
							* (buf[jp1][4] - 2.0 * buf[j][4] + buf[jm1][4])
							+ dy5ty1
							* (ue[jp1][4] - 2.0 * ue[j][4] + ue[jm1][4]);
				}
				...
				for (m = 0; m <= 4; m++) {
					for (j = 3; j <= grid_points[1] - 4; j++) {
						forcing[m][i][j][k] = forcing[m][i][j][k]
								- dssp
								* (ue[j - 2][m] - 4.0 * ue[j - 1][m] + 6.0
										* ue[j][m] - 4.0 * ue[j + 1][m] + ue[j + 2][m]);
					}
				}
		...
		for (j = 1; j <= grid_points[1] - 2; j++) {
			...
			for (i = 1; i <= grid_points[0] - 2; i++) {
				...
				for (k = 0; k <= grid_points[2] - 1; k++) {
					...
					buf[k][0] = cuf[k] + buf[k][1] * buf[k][1] + buf[k][2]
							* buf[k][2];
					q[k] = 0.5 * (buf[k][1] * ue[k][1] + buf[k][2] * ue[k][2] + buf[k][3]
							* ue[k][3]);
				}
				...
				for (k = 1; k <= grid_points[2] - 2; k++) {
					...
					forcing[0][i][j][k] = forcing[0][i][j][k] - tz2
							* (ue[kp1][3] - ue[km1][3]) + dz1tz1
							* (ue[kp1][0] - 2.0 * ue[k][0] + ue[km1][0]);

					forcing[1][i][j][k] = forcing[1][i][j][k]
							- tz2
							* (ue[kp1][1] * buf[kp1][3] - ue[km1][1]
									* buf[km1][3]) + zzcon2
							* (buf[kp1][1] - 2.0 * buf[k][1] + buf[km1][1])
							+ dz2tz1
							* (ue[kp1][1] - 2.0 * ue[k][1] + ue[km1][1]);

					forcing[2][i][j][k] = forcing[2][i][j][k]
							- tz2
							* (ue[kp1][2] * buf[kp1][3] - ue[km1][2]
									* buf[km1][3]) + zzcon2
							* (buf[kp1][2] - 2.0 * buf[k][2] + buf[km1][2])
							+ dz3tz1
							* (ue[kp1][2] - 2.0 * ue[k][2] + ue[km1][2]);

					forcing[3][i][j][k] = forcing[3][i][j][k]
							- tz2
							* ((ue[kp1][3] * buf[kp1][3] + c2
									* (ue[kp1][4] - q[kp1])) - (ue[km1][3]
									* buf[km1][3] + c2 * (ue[km1][4] - q[km1])))
							+ zzcon1
							* (buf[kp1][3] - 2.0 * buf[k][3] + buf[km1][3])
							+ dz4tz1
							* (ue[kp1][3] - 2.0 * ue[k][3] + ue[km1][3]);

					forcing[4][i][j][k] = forcing[4][i][j][k]
							- tz2
							* (buf[kp1][3] * (c1 * ue[kp1][4] - c2 * q[kp1]) - buf[km1][3]
									* (c1 * ue[km1][4] - c2 * q[km1])) + 0.5
							* zzcon3
							* (buf[kp1][0] - 2.0 * buf[k][0] + buf[km1][0])
							+ zzcon4 * (cuf[kp1] - 2.0 * cuf[k] + cuf[km1])
							+ zzcon5
							* (buf[kp1][4] - 2.0 * buf[k][4] + buf[km1][4])
							+ dz5tz1
							* (ue[kp1][4] - 2.0 * ue[k][4] + ue[km1][4]);
				}
				...
				for (m = 0; m <= 4; m++) {
					...
					forcing[m][i][j][k] = forcing[m][i][j][k]
							- dssp
							* (ue[k - 2 + m * jsize3] - 4.0*ue[k - 1][m] + 6.0 * ue[k][m] - 4.0 * ue[k + 1][m]);
					k = grid_points[2] - 2;
					forcing[m][i][j][k] = forcing[m][i][j][k]
							- dssp
			...
			for (j = 1; j <= ny2; j++) {
				for (i = 1; i <= nx2; i++) {
					...
					rhs[0][i][j][k] = rhs[0][i][j][k]
							+ dx1tx1
							* (u[0][(i + 1)][j][k] - 2.0 * u[0][i][j][k] + u[0][(i - 1)][j][k])
							- tx2 * (u[1][(i + 1)][j][k] - u[1][(i - 1)][j][k]);

					rhs[1][i][j][k] = rhs[1][i][j][k]
							+ dx2tx1
							* (u[1][(i + 1)][j][k] - 2.0 * u[1][i][j][k] + u[1][(i - 1)][j][k])
							+ xxcon2
							* con43
							* (up1 - 2.0 * uijk + um1)
							- tx2
				...
				for (m = 0; m <= 4; m++) {
					rhs[m][i][j][k] = rhs[m][i][j][k]
							- dssp
							* (5.0 * u[m][i][j][k] - 4.0 * u[m][(i + 1)][j][k] + u[m][(i + 2)][j][k]);
				}
				...
				for (m = 0; m <= 4; m++) {
					rhs[m][i][j][k] = rhs[m][i][j][k]
							- dssp
							* (u[m][(i - 2)][j][k] - 4. * u[m][(i - 1)][j][k] + 5. * u[m][i][j][k]);
				}
			}
		}
		if (timeron)
		...
		for (k = 1; k <= nz2; k++) {
			for (j = 1; j <= ny2; j++) {
				for (i = 1; i <= nx2; i++) {
					...
					rhs[0][i][j][k] = rhs[0][i][j][k]
							+ dy1ty1
							* (u[0][i][(j + 1)][k] - 2.0 * u[0][i][j][k] + u[0][i][(j - 1)][k])
					...
					rhs[1][i][j][k] = rhs[1][i][j][k]
							...
							* (us[i][(j + 1)][k] - 2.0 * us[i][j][k] + us[i][(j - 1)][k])
							- ty2
							* (u[1][i][(j + 1)][k] * vp1 - u[1][i][(j - 1)][k]
									* vm1);
					rhs[2][i][j][k] = rhs[2][i][j][k]
							+ dy3ty1
							* (u[2][i][(j + 1)][k] - 2.0 * u[2][i][j][k] + u[2][i][(j - 1)][k])
							+ yycon2
							* con43
							* (vp1 - 2.0 * vijk + vm1)
							- ty2
							* (u[2][i][(j + 1)][k] * vp1 - u[2][i][(j - 1)][k]
									* vm1 + (u[4][i][(j + 1)][k]
									- square[i][(j + 1)][k]
					...
					rhs[4][i][j][k] = rhs[4][i][j][k]
							...
							* (vp1 * vp1 - 2.0 * vijk * vijk + vm1 * vm1)
							+ yycon5
							* (u[4][i][(j + 1)][k] * rho_i[i][(j + 1)][k] - 2.0
									* u[4][i][j][k] * rho_i[i][j][k] + u[4][i][(j - 1)][k]
									* rho_i[i][(j - 1)][k])
							- ty2
							* ((c1 * u[4][i][(j + 1)][k] - c2
									* square[i][(j + 1)][k])
									* vp1 - (c1 * u[4][i][(j - 1)][k] - c2
									* square[i][(j - 1)][k])
									* vm1);
				}
			}
			...
			for (i = 1; i <= nx2; i++) {
				for (m = 0; m <= 4; m++) {
					rhs[m][i][j][k] = rhs[m][i][j][k]
							- dssp
							* (5.0 * u[m][i][j][k] - 4.0 * u[m][i][(j + 1)][k] + u[m][i][(j + 2)][k]);
				}
			}
			...
			for (i = 1; i <= nx2; i++) {
				for (m = 0; m <= 4; m++) {
					rhs[m][i][j][k] = rhs[m][i][j][k]
							- dssp
							* (u[m][i][(j - 2)][k] - 4. * u[m][i][(j - 1)][k] + 5. * u[m][i][j][k]);
				}
			}
		}
		if (timeron)
		...
		for (k = 1; k <= nz2; k++) {
			for (j = 1; j <= ny2; j++) {
				for (i = 1; i <= nx2; i++) {
					...
					rhs[0][i][j][k] = rhs[0][i][j][k]
							+ dz1tz1
							* (u[0][i][j][(k + 1)] - 2.0 * u[0][i][j][k] + u[0][i][j][(k - 1)])
					...
					rhs[2][i][j][k] = rhs[2][i][j][k]
							...
							* (vs[i][j][(k + 1)] - 2.0 * vs[i][j][k] + vs[i][j][(k - 1)])
							- tz2
							* (u[2][i][j][(k + 1)] * wp1 - u[2][i][j][(k - 1)]
									* wm1);
					rhs[3][i][j][k] = rhs[3][i][j][k]
							+ dz4tz1
							* (u[3][i][j][(k + 1)] - 2.0 * u[3][i][j][k] + u[3][i][j][(k - 1)])
							+ zzcon2
							* con43
							* (wp1 - 2.0 * wijk + wm1)
							- tz2
							* (u[3][i][j][(k + 1)] * wp1 - u[3][i][j][(k - 1)]
									* wm1 + (u[4][i][j][(k + 1)]
									- square[i][j][(k + 1)]
					...
					rhs[4][i][j][k] = rhs[4][i][j][k]
							...
							* (wp1 * wp1 - 2.0 * wijk * wijk + wm1 * wm1)
							+ zzcon5
							* (u[4][i][j][(k + 1)] * rho_i[i][j][(k + 1)] - 2.0
									* u[4][i][j][k] * rho_i[i][j][k] + u[4][i][j][(k - 1)]
									* rho_i[i][j][(k - 1)])
							- tz2
							* ((c1 * u[4][i][j][(k + 1)] - c2
									* square[i][j][(k + 1)])
									* wp1 - (c1 * u[4][i][j][(k - 1)] - c2
									* square[i][j][(k - 1)])
									* wm1);
				}
			}
		...
		for (j = 1; j <= ny2; j++) {
			for (i = 1; i <= nx2; i++) {
				for (m = 0; m <= 4; m++) {
					rhs[m][i][j][k] = rhs[m][i][j][k]
							- dssp
							* (5.0 * u[m][i][j][k] - 4.0 * u[m][i][j][(k + 1)] + u[m][i][j][(k + 2)]);
				}
			}
		}
		...
		for (j = 1; j <= ny2; j++) {
			for (i = 1; i <= nx2; i++) {
				for (m = 0; m <= 4; m++) {
					rhs[m][i][j][k] = rhs[m][i][j][k]
							- dssp
							* (u[m][i][j][(k - 2)] - 4. * u[m][i][j][(k - 1)] + 5. * u[m][i][j][k]);
				}
			}
		}
		if (timeron)
		...
		for (k = 1; k <= nz2; k++) {
			for (j = 1; j <= ny2; j++) {
				for (i = 1; i <= nx2; i++) {
					...
					t1 = c2
							* ac2inv
							* (qs[i][j][k] * r1 - uu * r2 - vv * r3 - ww * r4 + r5);
					t2 = bt * ru1 * (uu * r1 - r2);
					t3 = (bt * ru1 * ac) * t1;
		...
		for (k = 1; k <= nz2; k++) {
			for (j = 1; j <= ny2; j++) {
				...
				for (i = 0; i <= grid_points[0] - 3; i++) {
					...
					lhs[2][i1] = lhs[2][i1] - lhs[1][i1] * lhs[3][i];
					lhs[3][i1] = lhs[3][i1] - lhs[1][i1] * lhs[4][i];
					for (m = 0; m <= 2; m++) {
						rhs[m][i1][j][k] = rhs[m][i1][j][k] - lhs[1][i1]
								* rhs[m][i][j][k];
					}
					lhs[1][i2] = lhs[1][i2] - lhs[0][i2] * lhs[3][i];
					lhs[2][i2] = lhs[2][i2] - lhs[0][i2] * lhs[4][i];
					for (m = 0; m <= 2; m++) {
						rhs[m][i2][j][k] = rhs[m][i2][j][k] - lhs[0][i2]
								* rhs[m][i][j][k];
					}
				}
				...
				for (i = 0; i <= grid_points[0] - 3; i++) {
					...
					rhs[m][i][j][k] = fac1 * rhs[m][i][j][k];
					lhsp[2][i1] = lhsp[2][i1] - lhsp[1][i1] * lhsp[3][i];
					lhsp[3][i1] = lhsp[3][i1] - lhsp[1][i1] * lhsp[4][i];
					rhs[m][i1][j][k] = rhs[m][i1][j][k] - lhsp[1][i1]
							* rhs[m][i][j][k];
					lhsp[1][i2] = lhsp[1][i2] - lhsp[0][i2] * lhsp[3][i];
					lhsp[2][i2] = lhsp[2][i2] - lhsp[0][i2] * lhsp[4][i];
					rhs[m][i2][j][k] = rhs[m][i2][j][k] - lhsp[0][i2]
							* rhs[m][i][j][k];
					m = 4;
					fac1 = 1. / lhsm[2][i];
					...
					rhs[m][i][j][k] = fac1 * rhs[m][i][j][k];
					lhsm[2][i1] = lhsm[2][i1] - lhsm[1][i1] * lhsm[3][i];
					lhsm[3][i1] = lhsm[3][i1] - lhsm[1][i1] * lhsm[4][i];
					rhs[m][i1][j][k] = rhs[m][i1][j][k] - lhsm[1][i1]
							* rhs[m][i][j][k];
					lhsm[1][i2] = lhsm[1][i2] - lhsm[0][i2] * lhsm[3][i];
					lhsm[2][i2] = lhsm[2][i2] - lhsm[0][i2] * lhsm[4][i];
					rhs[m][i2][j][k] = rhs[m][i2][j][k] - lhsm[0][i2]
							* rhs[m][i][j][k];
				}
				...
				i1 = grid_points[0] - 1;
				for (m = 0; m <= 2; m++) {
					rhs[m][i][j][k] = rhs[m][i][j][k] - lhs[3][i]
							* rhs[m][i1][j][k];
				}

				rhs[3][i][j][k] = rhs[3][i][j][k] - lhsp[3][i]
						* rhs[3][i1][j][k];
				rhs[4][i][j][k] = rhs[4][i][j][k] - lhsm[3][i]
						* rhs[4][i1][j][k];
				...
				for (i = grid_points[0] - 3; i >= 0; i--) {
					...
					// ---------------------------------------------------------------------
					rhs[3][i][j][k] = rhs[3][i][j][k] - lhsp[3][i]
							* rhs[3][i1][j][k] - lhsp[4][i] * rhs[3][i2][j][k];
					rhs[4][i][j][k] = rhs[4][i][j][k] - lhsm[3][i]
							* rhs[4][i1][j][k] - lhsm[4][i] * rhs[4][i2][j][k];
				}
			}
		}
		if (timeron)
		...
		for (k = 1; k <= grid_points[2] - 2; k++) {
			for (i = 1; i <= grid_points[0] - 2; i++) {
				...
				for (j = 0; j <= grid_points[1] - 3; j++) {
					...
					for (m = 0; m <= 2; m++) {
						rhs[m][i][j1][k] = rhs[m][i][j1][k] - lhs[1][j1]
								* rhs[m][i][j][k];
					}
					lhs[1][j2] = lhs[1][j2] - lhs[0][j2] * lhs[3][j];
					lhs[2][j2] = lhs[2][j2] - lhs[0][j2] * lhs[4][j];
					for (m = 0; m <= 2; m++) {
						rhs[m][i][j2][k] = rhs[m][i][j2][k] - lhs[0][j2]
								* rhs[m][i][j][k];
					}
				}
				...
				j1 = grid_points[1] - 1;
				for (m = 0; m <= 2; m++) {
					rhs[m][i][j][k] = rhs[m][i][j][k] - lhs[3][j]
							* rhs[m][i][j1][k];
				}

				rhs[3][i][j][k] = rhs[3][i][j][k] - lhsp[3][j]
						* rhs[3][i][j1][k];
				rhs[4][i][j][k] = rhs[4][i][j][k] - lhsm[3][j]
						* rhs[4][i][j1][k];
				...
				for (j = grid_points[1] - 3; j >= 0; j--) {
					...
					// ---------------------------------------------------------------------
					rhs[3][i][j][k] = rhs[3][i][j][k] - lhsp[3][j]
							* rhs[3][i][j1][k] - lhsp[4][j] * rhs[3][i][j2][k];
					rhs[4][i][j][k] = rhs[4][i][j][k] - lhsm[3][j]
							* rhs[4][i][j1][k] - lhsm[4][j] * rhs[4][i][j2][k];
				}
			}
		}
		if (timeron)
