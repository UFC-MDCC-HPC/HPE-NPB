        ...
        public int getInputPars()
        {
            ...
            if (f2.exists())
            {
                ...
                try
                {
                    ...
                    niter = Integer.parseInt(datafile.readLine());
                    dt = Double.parseDouble(datafile.readLine());
                    grid_points[0] = Integer.parseInt(datafile.readLine());
                    grid_points[1] = Integer.parseInt(datafile.readLine());
                    grid_points[2] = Integer.parseInt(datafile.readLine());
                    datafile.close();
                }
                catch (Exception e)
                {
