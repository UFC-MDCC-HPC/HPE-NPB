...
namespace NPB
{
    public class BT : BTBase
    {
        ...
        public void runBenchMark()
        {
            ...
            for (c = 1; c <= maxcells; c++)
            {
                if ((cell_size[c,1] > IMAX) || (cell_size[c,2] > JMAX) || (cell_size[c,3] > KMAX))
                {
                    ...
                    Console.Write(" " + (cell_size[c,i]) + " "); Console.Write(" " + (cell_size[c,i]) + " "); Console.Write(" " + (cell_size[c,i]) + " ");
                    i = 3 + 1;
        ...
        public void exact_solution3(double xi, double eta, double zeta, ref double[, ,] dtemp, int d1, int d2)
        {
            ...
            for (m = 1; m <= 5; m++)
            {
                dtemp[d1, d2, m] = ce[1,m] + xi * (ce[2,m] + xi * (ce[5,m] + xi * (ce[8,m] + xi * ce[11,m]))) +
        ...
        public void exact_solution1(double xi, double eta, double zeta, ref double[] dtemp)
        {
            ...
            for (m = 1; m <= 5; m++)
            {
                dtemp[m] = ce[1,m] + xi * (ce[2,m] + xi * (ce[5,m] + xi * (ce[8,m] + xi * ce[11,m]))) +
                    eta * (ce[3,m] + eta * (ce[6,m] + eta * (ce[9,m] + eta * ce[12,m]))) +
                    zeta * (ce[4,m] + zeta * (ce[7,m] + zeta * (ce[10,m] + zeta * ce[13,m])));
            }
        }
                ...
                for (k = 0; k <= cell_size[c,3] - 1; k++)
                {
                    for (j = 0; j <= cell_size[c,2] - 1; j++)
                    {
                        ...
                        { //forcing[5,   0:IMAX-1, 0:JMAX-1, 0:KMAX-1, maxcells]
                            for (m = 1; m <= 5; m++)
                            {             //forcing new double[maxcells+1,KMAX,JMAX,IMAX,6];
                ...
                for (k = start[c,3]; k <= cell_size[c,3] - end[c,3] - 1; k++)
                {
                    ...
                    for (j = start[c,2]; j <= cell_size[c,2] - end[c,2] - 1; j++)
                    {
                        ...
                        if (start[c,1] > 0)
                        {
                            ...
                            {
                                i = 1;
                                forcing[c, k, j, i, m] = forcing[c, k, j, i, m] - dssp * (5.0d * ue[m,2 + i] - 4.0d * ue[m,2 + i + 1] + ue[m,2 + i + 2]);
                                i = 2;
                                forcing[c, k, j, i, m] = forcing[c, k, j, i, m] - dssp * (-4.0d * ue[m,2 + i - 1] + 6.0d * ue[m,2 + i] - 4.0d * ue[m,2 + i + 1] + ue[m,2 + i + 2]);
                            }
                        }
                        for (i = start[c,1] * 3; i <= cell_size[c,1] - 3 * end[c,1] - 1; i++)
                        {
                            for (m = 1; m <= 5; m++)
                            {
                                forcing[c, k, j, i, m] = forcing[c, k, j, i, m] - dssp * (ue[m,2 + i - 2] - 4.0d * ue[m,2 + i - 1] + 6.0d * ue[m,2 + i] - 4.0d * ue[m,2 + i + 1] + ue[m,2 + i + 2]);
                            }
                        }
                        if (end[c,1] > 0)
                        {
                            ...
                            {
                                i = cell_size[c,1] - 3;
                                forcing[c, k, j, i, m] = forcing[c, k, j, i, m] - dssp * (ue[m,2 + i - 2] - 4.0d * ue[m,2 + i - 1] + 6.0d * ue[m,2 + i] - 4.0d * ue[m,2 + i + 1]);
                                i = cell_size[c,1] - 2;
                                forcing[c, k, j, i, m] = forcing[c, k, j, i, m] - dssp * (ue[m,2 + i - 2] - 4.0d * ue[m,2 + i - 1] + 5.0d * ue[m,2 + i]);
                            }
                        }
                    }
                }
                ...
                for (k = start[c,3]; k <= cell_size[c,3] - end[c,3] - 1; k++)
                {
                    ...
                    for (i = start[c,1]; i <= cell_size[c,1] - end[c,1] - 1; i++)
                    {
                        ...
                        if (start[c,2] > 0)
                        {
                            ...
                            {
                                j = 1;
                                forcing[c, k, j, i, m] = forcing[c, k, j, i, m] - dssp * (5.0d * ue[m,2 + j] - 4.0d * ue[m,2 + j + 1] + ue[m,2 + j + 2]);
                                j = 2;
                                forcing[c, k, j, i, m] = forcing[c, k, j, i, m] - dssp * (-4.0d * ue[m,2 + j - 1] + 6.0d * ue[m,2 + j] - 4.0d * ue[m,2 + j + 1] + ue[m,2 + j + 2]);
                            }
                        }
                        for (j = start[c,2] * 3; j <= cell_size[c,2] - 3 * end[c,2] - 1; j++)
                        {
                            for (m = 1; m <= 5; m++)
                            {
                                forcing[c, k, j, i, m] = forcing[c, k, j, i, m] - dssp * (ue[m,2 + j - 2] - 4.0d * ue[m,2 + j - 1] + 6.0d * ue[m,2 + j] - 4.0d * ue[m,2 + j + 1] + ue[m,2 + j + 2]);
                            }
                        }
                        if (end[c,2] > 0)
                        {
                            ...
                            {
                                j = cell_size[c,2] - 3;
                                forcing[c, k, j, i, m] = forcing[c, k, j, i, m] - dssp * (ue[m,2 + j - 2] - 4.0d * ue[m,2 + j - 1] + 6.0d * ue[m,2 + j] - 4.0d * ue[m,2 + j + 1]);
                                j = cell_size[c,2] - 2;
                                forcing[c, k, j, i, m] = forcing[c, k, j, i, m] - dssp * (ue[m,2 + j - 2] - 4.0d * ue[m,2 + j - 1] + 5.0d * ue[m,2 + j]);
                            }
                        }
                    }
                }
                ...
                for (j = start[c,2]; j <= cell_size[c,2] - end[c,2] - 1; j++)
                {
                    ...
                    for (i = start[c,1]; i <= cell_size[c,1] - end[c,1] - 1; i++)
                    {
                        ...
                        if (start[c,3] > 0)
                        {
                            ...
                            {
                                k = 1;
                                forcing[c, k, j, i, m] = forcing[c, k, j, i, m] - dssp * (5.0d * ue[m,2 + k] - 4.0d * ue[m,2 + k + 1] + ue[m,2 + k + 2]);
                                k = 2;
                                forcing[c, k, j, i, m] = forcing[c, k, j, i, m] - dssp * (-4.0d * ue[m,2 + k - 1] + 6.0d * ue[m,2 + k] - 4.0d * ue[m,2 + k + 1] + ue[m,2 + k + 2]);
                            }
                        }
                        for (k = start[c,3] * 3; k <= cell_size[c,3] - 3 * end[c,3] - 1; k++)
                        {
                            for (m = 1; m <= 5; m++)
                            {
                                forcing[c, k, j, i, m] = forcing[c, k, j, i, m] - dssp * (ue[m,2 + k - 2] - 4.0d * ue[m,2 + k - 1] + 6.0d * ue[m,2 + k] - 4.0d * ue[m,2 + k + 1] + ue[m,2 + k + 2]);
                            }
                        }
                        if (end[c,3] > 0)
                        {
