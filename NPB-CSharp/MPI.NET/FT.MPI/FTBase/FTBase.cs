    ...
    public class FTBase {
      ...
      //******************************************** Attributes *******************************************************
        ...
        //global.h
            ...
            protected static bool debug, debugsynch;
            protected double seed = 314159265, a = 1220703125, pi = Math.PI, alpha=.000001;
            protected static int REAL=0,IMAG=1;

            protected static double[,] u; protected static double[] uUnidimensional;  //complex u(nx);
        ...
        //ft.f
            ...
            protected char clss; //clss==class in fortran code, because class is reserved word in c#
      ...
      //***************************************************************************************************************
        ...
        public FTBase(char c){
            this.clss = c;
            string dayOfCompile="01 Jan 2010";
            switch (this.clss) {
                case ('S'):
                    nx=ny=nz=64;
                    niter_default=6;
