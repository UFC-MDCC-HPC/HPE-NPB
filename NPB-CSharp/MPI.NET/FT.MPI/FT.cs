...
namespace NPB {
    public class FT:FTBase {
        ...
        public void runBenchMark() {
            ...
            if (me == 0) {
                print_results("FT", clss, nx, ny, nz, niter, np_min, np,total_time, mflops, "floating point", verified, npbversion);
            }
        ...
        public void print_results(string name, char Class, int n1, int n2, int n3, int niter, int nprocs_compiled, int nprocs_total,
                                         double t, double mops, string optype, bool verified, string npbversion) {
