...
namespace impl.sp.solve.ZSolver { 
	...
	public class IZSolverImpl<I, C, MTH, DIR> : BaseIZSolverImpl<I, C, MTH, DIR>, ISPSolver<I, C, MTH, DIR>
...
*/
                ...
                Input_buffer_forward.Array = in_buffer_z = in_buffer_solver[0,stage];// new double[22 * buffer_size];
                Output_buffer_forward.Array = out_buffer_z = out_buffer_solver[0,stage];// new double[22 * buffer_size];
            ...
            for (stage = ncells - 1; stage >= 0; stage--)
            {
                ...
                */
                ...
                Input_buffer_backward.Array = in_buffer_z = in_buffer_solver[1,stage]; // new double[10 * buffer_size];
                Output_buffer_backward.Array = out_buffer_z = out_buffer_solver[1,stage]; // new double[10 * buffer_size];
