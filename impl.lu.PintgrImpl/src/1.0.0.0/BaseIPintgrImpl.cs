...
{ 
		...
		where C:IClass 
	{
		...
		private IExchange2D<I, C, IExchangePattern4> exchange4 = null;
		protected IExchange2D<I, C, IExchangePattern4> Exchange4 {
			get {
				if (this.exchange4 == null)
					this.exchange4 = (IExchange2D<I, C, IExchangePattern4>) Services.getPort("exchange4");
				return this.exchange4;
			}
		}
		
		private IExchange2D<I, C, IExchangePattern5> exchange5 = null;
		protected IExchange2D<I, C, IExchangePattern5> Exchange5 {
			get {
				if (this.exchange5 == null)
					this.exchange5 = (IExchange2D<I, C, IExchangePattern5>) Services.getPort("exchange5");
				return this.exchange5;
			}
		}

		private IExchange2D<I, C, IExchangePattern6> exchange6 = null;
		protected IExchange2D<I, C, IExchangePattern6> Exchange6 {
			get {
				if (this.exchange6 == null)
					this.exchange6 = (IExchange2D<I, C, IExchangePattern6>) Services.getPort("exchange6");
